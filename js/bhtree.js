		...
		function createChild(point,quadrant,bbox){
			...
			switch(quadrant){
				...
				case 3:
					...
					break;
				case 4:
					max={x:bbox.max.x,y:bbox.max.y,z:bbox.min.z}
					break;
				case 5:
					max={x:bbox.min.x,y:bbox.max.y,z:bbox.min.z}
					break;
				case 6:
					max=bbox.min
					break;
				default:
					max={x:bbox.max.x,y:bbox.min.y,z:bbox.min.z}
					break;
			}
